...
Welcome to the <strong>Top Interview 150</strong> repository! 🎯

This repository contains my solutions to the top 150 LeetCode interview questions, implemented in both Python and Rust. This project aims to build a solid understanding of commonly asked coding problems, enhance problem-solving skills, and prepare thoroughly for technical interviews.

## 📁 Structure of the Repository

Each problem is stored in its respective folder, containing:

- A detailed problem description.
- Python and Rust solutions.
- Explanation of the approach and complexity analysis.

## 📚 Problem Set Overview

Below is a categorized list of problems, along with their difficulty levels and completion status:
...
<table>
    ...
    <tr>
        <td colspan="4" align="center"><strong>Two Pointers</strong> (0-5)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>#392 Is Subsequence</td>
        <td>🟢 Easy</td>
        <td></td>
    </tr>
    <tr>
        <td colspan="4" align="center"><strong>Sliding Windows</strong> (0/4)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="4" align="center"><strong>Matrix</strong> (0/5)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="4" align="center"><strong>Hashmap</strong> (0/9)</td>
    </tr>
    <tr>
        <td>#1 Two Sum</td>
        <td>🟢 Easy</td>
    ...
    <tr>
        <td colspan="4" align="center"><strong>Intervals</strong> (0/4)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>#228 Summary Range</td>
        <td>🟢 Easy</td>
        <td></td>
    </tr>
    <tr>
        <td>#452 Minimum Number of Array to Burst Balloons</td>
        <td>🟡 Medium</td>
        <td></td>
    </tr>
    <tr>
        <td colspan="4" align="center"><strong>Stack</strong> (0/5)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="4" align="center"><strong>Linked List</strong> (0/11)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td><a href='https://github.com/nimodb/top-interview-150/tree/main/linked-list/21-merge-two-stored-lists'>#21 Merge Two Sorted Lists</a></td>
        <td>🟢 Easy</td>
        <td>
            ✅ Python
            <br>
    ...
    <tr>
        <td>#82 Remove Nth Node From End of list II</td>
        <td>🟡 Medium</td>
        <td></td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="4" align="center"><strong>Binary Tree General</strong> (0/14)</td>
    </tr>
    <tr>
        <td>#100 Same Tree</td>
        <td>🟢 Easy</td>
    ...
    <tr>
        <td>#106 Construct Binary Tree from InOrder and PreOrder Traversal</td>
        <td>🟡 Medium</td>
        <td></td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="4" align="center"><strong>Binary Tree BFS</strong> (0/4)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="4" align="center"><strong>Binary Search Tree</strong> (0/3)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="4" align="center"><strong>Graph General</strong> (0/6)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="4" align="center"><strong>Graph BFS</strong> (0/3)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="4" align="center"><strong>Trie</strong> (0/3)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="4" align="center"><strong>Backtracking</strong> (0/7)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="4" align="center"><strong>Divide &amp; Conquer</strong> (0/4)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="4" align="center"><strong>Kadane's Algorithm</strong> (0/2)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="4" align="center"><strong>Binary Search</strong> (0/7)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="4" align="center"><strong>Heap</strong> (0/4)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="4" align="center"><strong>Bit Manipulation</strong> (0/6)</td>
    </tr>
    <tr>
        <td>#67 Add Binary</td>
        <td>🟢 Easy</td>
    ...
    <tr>
        <td colspan="4" align="center"><strong>Math</strong> (0/6)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="4" align="center"><strong>1D DP</strong> (0/5)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="4" align="center"><strong>Multidimensional DP</strong> (0/8)</td>
    </tr>
    <tr>
